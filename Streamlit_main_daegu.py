...
def load_excel_data():
    ...
    df_diner = pd.read_excel('./seoul_data/whatToEat_DB_daegu.xlsx', sheet_name='diner', index_col=0)
    df_review = pd.read_excel('./seoul_data/whatToEat_DB_daegu.xlsx', sheet_name='review', index_col=0)
